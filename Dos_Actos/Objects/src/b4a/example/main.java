...
int _i = 0;
 //BA.debugLineNum = 88;BA.debugLine="Sub Bott_Click";
 //BA.debugLineNum = 89;BA.debugLine="Activity.RemoveAllViews";
mostCurrent._activity.RemoveAllViews();
 //BA.debugLineNum = 90;BA.debugLine="Activity.LoadLayout(\"panta1\")";
mostCurrent._activity.LoadLayout("panta1",mostCurrent.activityBA);
 //BA.debugLineNum = 91;BA.debugLine="For i=0 To cont-1";
{
final int step3 = 1;
final int limit3 = (int) (_cont-1);
for (_i = (int) (0) ; (step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3); _i = ((int)(0 + _i + step3)) ) {
 //BA.debugLineNum = 92;BA.debugLine="Spinner1.Add(car(i).Patente)";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 59;BA.debugLine="car(cont).Initialize";
mostCurrent._car[_cont].Initialize();
 //BA.debugLineNum = 60;BA.debugLine="car(cont).hllegada=EditText1.Text";
mostCurrent._car[_cont].hllegada = (int)(Double.parseDouble(mostCurrent._edittext1.getText()));
 //BA.debugLineNum = 61;BA.debugLine="car(cont).mllegada=EditText2.Text";
mostCurrent._car[_cont].mllegada = (int)(Double.parseDouble(mostCurrent._edittext2.getText()));
 //BA.debugLineNum = 62;BA.debugLine="car(cont).Patente=EditText5.Text";
mostCurrent._car[_cont].Patente = mostCurrent._edittext5.getText();
 //BA.debugLineNum = 63;BA.debugLine="car(cont).fechallegada=DateTime.Date(DateTime.now";
mostCurrent._car[_cont].fechallegada = anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 64;BA.debugLine="car(cont).hsalida=EditText3.Text";
mostCurrent._car[_cont].hsalida = (int)(Double.parseDouble(mostCurrent._edittext3.getText()));
 //BA.debugLineNum = 65;BA.debugLine="car(cont).msalida=EditText4.Text";
mostCurrent._car[_cont].msalida = (int)(Double.parseDouble(mostCurrent._edittext4.getText()));
 //BA.debugLineNum = 66;BA.debugLine="Spinner1.Add(car(cont).Patente)";
mostCurrent._spinner1.Add(mostCurrent._car[_cont].Patente);
 //BA.debugLineNum = 67;BA.debugLine="cont=cont+1";
_cont = (int) (_cont+1);
...
int _mins = 0;
 //BA.debugLineNum = 71;BA.debugLine="Sub Spinner1_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 72;BA.debugLine="Activity.LoadLayout(\"resultados\")";
mostCurrent._activity.LoadLayout("resultados",mostCurrent.activityBA);
 //BA.debugLineNum = 73;BA.debugLine="fondo.Bitmap=LoadBitmap(File.DirAssets,\"white.jpe";
mostCurrent._fondo.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"white.jpeg").getObject()));
 //BA.debugLineNum = 74;BA.debugLine="Patente.Text=car(Position).Patente";
mostCurrent._patente.setText((Object)(mostCurrent._car[_position].Patente));
 //BA.debugLineNum = 75;BA.debugLine="Entrada.Text=car(Position).hllegada&\":\"&car(Posit";
mostCurrent._entrada.setText((Object)(BA.NumberToString(mostCurrent._car[_position].hllegada)+":"+BA.NumberToString(mostCurrent._car[_position].mllegada)));
 //BA.debugLineNum = 76;BA.debugLine="Salida.Text=car(Position).hsalida&\":\"&car(Positio";
mostCurrent._salida.setText((Object)(BA.NumberToString(mostCurrent._car[_position].hsalida)+":"+BA.NumberToString(mostCurrent._car[_position].msalida)));
 //BA.debugLineNum = 77;BA.debugLine="Fecha.Text=car(Position).fechallegada";
mostCurrent._fecha.setText((Object)(mostCurrent._car[_position].fechallegada));
 //BA.debugLineNum = 78;BA.debugLine="Dim Mins As Int=(car(Position).hsalida-car(Positi";
_mins = (int) ((mostCurrent._car[_position].hsalida-mostCurrent._car[_position].hllegada)*60+(mostCurrent._car[_position].msalida-mostCurrent._car[_position].mllegada));
 //BA.debugLineNum = 79;BA.debugLine="Minutos.Text=Mins";
mostCurrent._minutos.setText((Object)(_mins));
 //BA.debugLineNum = 80;BA.debugLine="If Mins>30 Then";
if (_mins>30) { 
 //BA.debugLineNum = 81;BA.debugLine="pagar.Text=((Mins-30)*35+500)&\"$\"";
mostCurrent._pagar.setText((Object)(BA.NumberToString(((_mins-30)*35+500))+"$"));
 }else {
 //BA.debugLineNum = 83;BA.debugLine="pagar.Text=500&\"$\"";
